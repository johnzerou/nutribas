...
- Preciso que ao cadastrar o paciente eu possa colocar a data de início do tratamento, essa data ficará registrada como primeia consulta.
...
- Todas as alterações devem ser salvas no Neon
...
- Possibilide de adicionar foto no cadastro das pessoas
